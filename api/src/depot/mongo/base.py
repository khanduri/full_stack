...
class TableEnum(enum.Enum):
    ...
    PROJECTS_USER = Table('projects_user')
    PROJECTS_PROJECT = Table('projects_project')
    PROJECTS_USER_PROJECT = Table('projects_user_project')
    PROJECTS_TIMESHEET = Table('projects_timesheet')
...
def mongo_db(collection_name):
    ...
    if not _mongo_connections:
        _mongo_connections = {
            ...
            TableEnum.PROJECTS_USER.name:           mongo.db.projects_user,
            TableEnum.PROJECTS_PROJECT.name:        mongo.db.projects_project,
            TableEnum.PROJECTS_USER_PROJECT.name:   mongo.db.projects_user_project,
            TableEnum.PROJECTS_TIMESHEET.name:      mongo.db.projects_timesheet,
        }
