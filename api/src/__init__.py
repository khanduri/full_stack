...
def create_app(config=None):
    ...
    from src.micro_services.projects import apis  # noqa: E402,F401
    ...
    app.register_blueprint(projects_api_v1_bp, url_prefix='/api/v1/projects')
...
projects_api_v1_bp = Blueprint('projects_apis', __name__)
