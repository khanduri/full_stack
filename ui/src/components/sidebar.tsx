  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <ellipse cx="9" cy="17" rx="7" ry="4" strokeWidth="1.5" />
      <path
...
function IconProjects() {
  return (
    ...
    >
      ...
      <path d="M15 12L4 12" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M9 17H4" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
export default function Component({
  ...
  const sidelink = [
    ...
    { title: "Projects", url: "/projects", icon: IconProjects },
